...
urlpatterns = [
    ...
    path("digital-training/products", views.training_products, name="training_products"),
    path("digital-training/products/<int:pk>", views.training_product_detail, name="training_product_detail"),
