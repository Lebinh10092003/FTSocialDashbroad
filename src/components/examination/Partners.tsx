...
type Props = { partners: Partner[]; onPartnersChange: (partners: Partner[]) => void; actor?: string | null; idToken?: string | null; canManage: boolean; canDelete: boolean; };
...
export default function Partners({ partners, onPartnersChange, actor, idToken, canManage, canDelete }: Props) {
  ...
  const toggleAllFilteredPartners = () => {
    const filteredIds = filtered.map((partner) => partner.id);
