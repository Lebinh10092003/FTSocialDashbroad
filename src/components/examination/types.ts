...
export type Candidate = { code: string; name: string; school: string; className: string; city: string; contests: string; achievement: string; updated: string; email: string; parent: string; phone: string; identity: string; address: string; birthDate: string };
