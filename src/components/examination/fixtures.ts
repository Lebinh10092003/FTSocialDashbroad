...
export const initialCandidates: Candidate[] = [
  { code: 'FT26-0001', name: 'Nguyễn Minh Anh', school: 'THCS Cầu Giấy', className: '8A1', city: 'Hà Nội', contests: 'AYSBC, IMO', achievement: 'HCV — AYSBC 2025', updated: '18/07/2026 09:20', email: 'minhanh@example.com', parent: 'Nguyễn Thu Hà', phone: '0988 123 456', identity: '001212345678', address: 'Cầu Giấy, Hà Nội' },
  { code: 'FT26-0042', name: 'Trần Gia Bảo', school: 'THCS Lê Quý Đôn', className: '9A3', city: 'Đà Nẵng', contests: 'IMO, ISO', achievement: 'HCB — IMO 2025', updated: '17/07/2026 16:45', email: 'giabao@example.com', parent: 'Trần Văn Long', phone: '0912 456 789', identity: '048211234567', address: 'Hải Châu, Đà Nẵng' },
  { code: 'FT26-0079', name: 'Lê Hoàng Nam', school: 'Tiểu học Đoàn Thị Điểm', className: '7A2', city: 'Hà Nội', contests: 'AYSBC, IEO', achievement: 'Top 10 — IEO 2025', updated: '16/07/2026 11:05', email: 'hoangnam@example.com', parent: 'Lê Thị Mai', phone: '0903 555 222', identity: '001213456789', address: 'Nam Từ Liêm, Hà Nội' },
];
