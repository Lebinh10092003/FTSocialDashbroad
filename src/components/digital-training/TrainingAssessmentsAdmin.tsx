      ...
      <section className="mt-6 space-y-5">
        ...
        <div className="rounded-2xl border bg-white p-6 shadow-sm">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div><p className="text-xs font-bold uppercase tracking-wider text-blue-600">Khảo sát kết thúc tập huấn</p><h2 className="mt-1 text-2xl font-extrabold">Tạo một link, chia đều nhiều mã đề</h2><p className="mt-2 text-sm text-slate-500">Nhập câu hỏi từ XLSX hoặc Google Sheet, kiểm tra dữ liệu rồi phát hành.</p></div>
