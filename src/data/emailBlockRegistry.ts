...
export const EMAIL_BLOCK_REGISTRY: Record<BlockType, EmailBlockDefinition> = {
  ...
  'signature-builder': block('signature-builder','brand','Trình tạo chữ ký','ContactRound',{logoUrl:FERMATTECH_EMAIL_LOGO_URL,logoAlt:'FermatTech',logoWidth:150,width:650,fullName:'HỌ VÀ TÊN',jobTitle:'Chức vụ',company:'CÔNG TY CỔ PHẦN CÔNG NGHỆ FERMAT',phone:'',email:'',website:'www.fermat.vn',address:'',accentColor:'#1473D1',textColor:'#28323D',titleSize:22,bodySize:12,padding:18,showFacebook:true,facebookUrl:'https://facebook.com',showLinkedIn:false,linkedInUrl:'https://linkedin.com',showYoutube:false,youtubeUrl:'https://youtube.com',showInstagram:false,instagramUrl:'https://instagram.com',showOther:false,otherLabel:'Kênh khác',otherUrl:''},'Chữ ký có logo, thông tin liên hệ, mạng xã hội và kích thước tùy chỉnh',[{value:'horizontal',label:'Logo trái'}]),
