...
export const EMAIL_BLOCK_REGISTRY: Record<BlockType, EmailBlockDefinition> = {
  ...
  'icon-text': block('icon-text','icons','Icon / Emoji + chữ','BadgeCheck',{iconSource:'library',iconName:'CircleCheck',iconUrl:'',text:'',iconSize:24,fontSize:15,gap:10,iconColor:'#1473D1',color:'#1E293B',align:'left',verticalAlign:'middle'},'Chọn trong 81 icon hoặc tải icon riêng; icon và chữ luôn cùng hàng'),
  ...
  'highlight-box': block('highlight-box','content','Hộp thông tin','Info',{html:'',bg:'#eef6ff',borderColor:'#1473d1',padding:16},'Thông tin cần chú ý'),
  ...
  signature: block('signature','brand','Chữ ký','PenLine',{html:''},'Thông tin đơn vị gửi'),
  'signature-builder': block('signature-builder','brand','Trình tạo chữ ký','ContactRound',{logoUrl:FERMATTECH_EMAIL_LOGO_URL,logoAlt:'FermatTech',logoWidth:150,width:650,fullName:'HỌ VÀ TÊN',jobTitle:'Chức vụ',company:'CÔNG TY CỔ PHẦN CÔNG NGHỆ FERMAT',phone:'',email:'',secondaryEmail:'',website:'www.fermat.vn',address:'',accentColor:'#1473D1',textColor:'#28323D',titleSize:22,bodySize:12,padding:18,showJobTitle:true,showCompany:true,showPhone:true,showEmail:true,showSecondaryEmail:false,showWebsite:true,showAddress:true,showFacebook:false,facebookUrl:'',showZalo:false,zaloUrl:'',showLinkedIn:false,linkedInUrl:'',showYoutube:false,youtubeUrl:'',showInstagram:false,instagramUrl:'',showOther:false,otherLabel:'Kênh khác',otherUrl:'',customFields:[]},'Chữ ký có logo, thông tin liên hệ, mạng xã hội và kích thước tùy chỉnh',[{value:'horizontal',label:'Logo trái'}]),
  ...
  section: block('section','layout','Section / Container','SquareDashed',{variant:'style-1',heading:'',body:'',bg:'#f8fafc',padding:24},'Nền, viền và khoảng đệm'),
  ...
  'data-table': block('data-table','content','Bảng dữ liệu','Table2',{variant:'style-1',heading:'',rows:[['Hạng mục','Nội dung'],['Thời gian','08:00 - 10:00'],['Địa điểm','Fermat Workspace']]},'Lịch học, điểm số hoặc thông tin'),
