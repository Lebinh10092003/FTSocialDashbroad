...
async function startServer() {
  ...
  // Ưu tiên gửi ảnh dạng nhị phân để không làm tăng dung lượng khoảng 33% như Base64.
  // Parser JSON được giữ lại tạm thời để tương thích với các bản giao diện cũ đang mở.
  app.use(
    '/api/upload',
